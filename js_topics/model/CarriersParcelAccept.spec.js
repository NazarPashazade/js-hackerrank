...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CarriersParcelAccept', function() {
      beforeEach(function() {
        instance = new CarriersV2.CarriersParcelAccept();
      });

      it('should create an instance of CarriersParcelAccept', function() {
        // TODO: update the code to test CarriersParcelAccept
        expect(instance).to.be.a(CarriersV2.CarriersParcelAccept);
      });
