...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CarriersParcelList', function() {
      beforeEach(function() {
        instance = new CarriersV2.CarriersParcelList();
      });

      it('should create an instance of CarriersParcelList', function() {
        // TODO: update the code to test CarriersParcelList
        expect(instance).to.be.a(CarriersV2.CarriersParcelList);
      });
