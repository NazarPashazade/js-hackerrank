...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CarriersCommercialPostData', function() {
      beforeEach(function() {
        instance = new CarriersV2.CarriersCommercialPostData();
      });

      it('should create an instance of CarriersCommercialPostData', function() {
        // TODO: update the code to test CarriersCommercialPostData
        expect(instance).to.be.a(CarriersV2.CarriersCommercialPostData);
      });
