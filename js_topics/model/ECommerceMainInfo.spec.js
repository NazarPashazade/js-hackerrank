...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ECommerceMainInfo', function() {
      beforeEach(function() {
        instance = new CarriersV2.ECommerceMainInfo();
      });

      it('should create an instance of ECommerceMainInfo', function() {
        // TODO: update the code to test ECommerceMainInfo
        expect(instance).to.be.a(CarriersV2.ECommerceMainInfo);
      });
